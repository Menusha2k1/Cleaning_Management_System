        ...
        <div className='flex items-center justify-center w-full mt-40 drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]'>
            ...
            <div className="w-100 rounded-3xl bg-white p-10 z-1" >
                <form onSubmit={handleLogin}>
                    <h4 className="text-5xl mb-8 py-5 ">Login</h4>

                    <input
                        type="text"
                        placeholder="Username"
                        className="py-5 text-2xl p-3 border-1 rounded-3xl border-gray-400 mb-5"
                        value={username}
                    ...
                    <button type='submit' className='bg-green-700 text-white p-5 text-2xl w-full rounded-3xl'>Login</button>
